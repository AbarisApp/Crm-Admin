...
function HotelDiscountFilter({ filterInitial, handleChange, getTransitionReport }) {
                        ...
                        <div className="card-body p-0">
                            <div className="table-responsive active-projects style-1">
                                <div className="tbl-caption tbl-caption-2">
                                    <h4 className="heading mb-0"><b>Hotel DISCOUNT SEARCH
                                    </b></h4>
                                </div>
                                <div className="row">
...
export default HotelDiscountFilter