...
//         { id: 1, item: '', BatchNo: '', Tax: 0, Location: '', Quantity2: '', Quantity: 0, Amount: 0 },
//         { id: 2, item: '', BatchNo: '', Tax: 0, Location: '', Quantity2: '', Quantity: 0, Amount: 0 },
//         { id: 3, item: '', BatchNo: '', Tax: 0, Location: '', Quantity2: '', Quantity: 0, Amount: 0 },
//         { id: 4, item: '', BatchNo: '', Tax: 0, Location: '', Quantity2: '', Quantity: 0, Amount: 0 },
//     ]);
...
//                                     <h4 className="heading mb-0">Add Sales Challan</h4>
//                                 </div>
//                                 <div className="row">
                ...
                <div className="col-xl-12">
                    <div className="card">
                        <div className="card-body p-0">
                            <div className="table-responsive active-projects style-1">
                                <div className="tbl-caption tbl-caption-2">
                                    <h4 className="heading mb-0 p-2">Add Purchase Challan</h4>
                                </div>
                                <div className="row">
                                    <div className="col-md-3 mb-3">
                                        <label htmlFor="voucher">Date </label>
