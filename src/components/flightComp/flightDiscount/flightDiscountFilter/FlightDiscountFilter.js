...
import FlightMarkupForm from '../flightDiscountForm/FlightDiscountForm';
function FlightDiscountFilter({ filterInitial, handleChange, getTransitionReport }) {
    ...
    return (
        <>
                        ...
                        <div className="card-body p-0">
                            <div className="table-responsive active-projects style-1">
                                <div className="tbl-caption tbl-caption-2">
                                    <h4 className="heading mb-0"><b>FLIGHT DISCOUNT SEARCH
                                    </b></h4>
                                </div>
                                <div className="row">
            ...
            {/* <FlightMarkupForm show={show} setShow={setShow} /> */}
        </>
    )
}

export default FlightDiscountFilter