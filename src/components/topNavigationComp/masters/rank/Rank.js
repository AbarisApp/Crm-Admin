...
import { deletranking, getranking } from "../../../../api/login/Login";
...
const Rank = () => {
    ...
    const getTransitionReport = async (input) => {
        ...
        try {
            const res = await getranking(clone)
            if (res?.error == false) {
    ...
    const deleteData = async (id) => {
        try {
            const res = await deletranking(id)
            // console.log(res);
            if (res?.error == false) {
                toastSuccessMessage()
    ...
    return (
        <>
            ...
            <RankFilter filterInitial={filterInitial} handleChange={handleChange} getTransitionReport={getTransitionReport} />
            <div>
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Rank Master
                                        </h4>
                                        <Link to='/rank-add' className="btn btn-primary">Add Rank Master</Link>
                                    </div>
                                                    ...
                                                    return <tr role="row" key={item?._id}>
                                                        ...
                                                        <td>
                                                            <div className="d-flex">
                                                                <Link to={`/rank-update/${item?._id}`} className="btn btn-primary shadow btn-xs sharp me-1">
