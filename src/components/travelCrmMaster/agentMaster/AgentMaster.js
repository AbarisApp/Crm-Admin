...
import AgentMasterFilter from "./agentMasterFilter/AgentMasterFilter";
import { deleteagentClass, gitagentClass } from "../../../api/login/Login";
...
const AgentMaster = () => {
    ...
    const getTransitionReport = async (input) => {
        ...
        try {
            const res = await gitagentClass(clone)
    ...
    const deleteData = async (id) => {
        try {
            const res = await deleteagentClass(id)
            // console.log(res);
            if (res?.error == false) {
                toastSuccessMessage()
    ...
    return (
        <>
            ...
            <AgentMasterFilter filterInitial={filterInitial} handleChange={handleChange} getTransitionReport={getTransitionReport} />
            <div>
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Travel Agent Master
                                        </h4>
                                        <Link to='/travel-agent-add' className="btn btn-primary">Add Agent Master</Link>
                                    </div>
                                                    ...
                                                    return <tr role="row" key={item?._id}>
                                                        ...
                                                        <td>
                                                            <div className="d-flex">
                                                                <Link to={`/travel-agent-update/${item?._id}`} className="btn btn-primary shadow btn-xs sharp me-1">
