...
import AmendmentsMasterFilter from "./amendmentsMasterFilter/AmendmentsMasterFilter";
import { deleteAmmedmentType, gitAmmedmentType } from "../../../api/login/Login";


const AmendmentsMaster = () => {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Travel CRM Master",
        title_2: 'Travel Amendments Type Master',
        path_2: ``
    };
    ...
    const getTransitionReport = async (input) => {
        ...
        try {
            const res = await gitAmmedmentType(clone)
    ...
    const deleteData = async (id) => {
        try {
            const res = await deleteAmmedmentType(id)
            // console.log(res);
            if (res?.error == false) {
                toastSuccessMessage()
    ...
    return (
        <>
            ...
            <AmendmentsMasterFilter filterInitial={filterInitial} handleChange={handleChange} getTransitionReport={getTransitionReport} />
            <div>
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Amendments Type Master</h4>
                                        <Link to='/hotel-amendments-type-add' className="btn btn-primary">Add Amendments Type Master</Link>
                                    </div>
                                        ...
                                        <table id="banner-tblwrapper" className="table dataTable no-footer" role="grid" aria-describedby="banner-tblwrapper_info">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th style={{ width: '150px' }}>Amendments Type Name</th>
...
export default AmendmentsMaster